													...
													<tr>
														...
														<td>
															...
															<button class="btn btn-sm btn-info" title="查看"
																type="button" onclick="CNselect('${con.AZ_UUID}');">查看
															</button>
														...
														<c:if test="${con.ACT_STATUS == '1'}">
															<button class="btn  btn-warning btn-sm" title="启动流程"
																	type="button" onclick="startLeave('${con.AZ_UUID}','${con.ACT_KEY}')">启动
															</button>
														</c:if>
														
														 <c:if test="${con.ACT_STATUS == '5'}">
															<button class="btn  btn-warning btn-sm" title="重新提交" type="button" 
															onclick="restartAgent('${con.task_id }','${con.AZ_UUID}');">重新提交</button>
														  </c:if>
														...
														<c:if test="${con.ACT_STATUS == '4'}">
															...
															<a class="btn btn-sm btn-warning" title="合同输出" type="button" target="_blank" href="<%=basePath%>contractNewInstallation/toContractInstallation.do">合同输出</a>
														</c:if> 
														</td>
													</tr>
												</c:forEach>
