	                    ...
	                    <div id="top",name="top"></div>
	                        <form role="form" class="form-inline" action="sysAgent/agentList.do" method="post" name="menuForm" id="menuForm">
	                            <div class="form-group ">
	                                <input type="text" name="agent_name" value="${agent_name}" placeholder="这里输入名称" class="form-control">
	                            </div>
	                        ...
	                        <div class="table-responsive" >
											...
											<c:if test="${QX.cha == 1 }">
												<c:forEach items="${agentList}" var="var" varStatus="vs">
													<tr id="${var.autoid }">
														...
														<td>
															<c:if test="${var.agent_type eq 1 and var.is_constructor eq 1}">
																代理商有安装资质
															</c:if>
															<c:if test="${var.agent_type eq 1 and var.is_constructor eq 2}">
																代理商
															</c:if>
														</td>
														<td>
								...
								<div class="col-lg-12" style="padding-left:0px;padding-right:0px">
									...
									<a class="btn btn-warning" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>sysAgent/toExcel.do">导出</a>
