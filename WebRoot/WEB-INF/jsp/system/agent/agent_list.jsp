...
<body class="gray-bg">
																...
																<tr>
																	...
																	<td>
																		...
																		<c:if test="${agent.type == '1'}">
																			<button class="btn  btn-warning btn-sm" title="办理" type="button" onclick="goHandleAgent('${agent.task_id}','${agent.agent_id }');">办理</button>
																		</c:if>
																	</td>
	...
	<script type="text/javascript">
	 ...
	 //办理任务
	 function goHandleAgent(task_id,agent_id){
		 $("#handleLeave").kendoWindow({
			 width: "600px",
			 height: "300px",
			 title: "办理任务",
			 actions: ["Close"],
			 content: '<%=basePath%>sysAgent/goHandleAgent?task_id='+task_id+'&agent_id='+agent_id,
			 modal : true,
			 visible : false,
			 resizable : true
		 }).data("kendoWindow").center().open();
