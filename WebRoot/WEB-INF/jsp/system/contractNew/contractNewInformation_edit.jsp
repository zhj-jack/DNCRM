						                    ...
						                    <div class="form-group form-inline">                                
												...
												<label style="width:10%;">
			                                 		...
			                                 		<select style="width:22%" name="HT_JHFS" id="HT_JHFS" class="form-control">
			                                  		...
			                                  		<option value="1" ${pd.HT_JHFS=='1'?'selected':''}>乙方代办运输</option>
															...
															<tr>
																...
																<td>
																	<select class="form-control" id="" name='FKFS_PDRQ'>
												                        ...
												                        <option value="2" ${con.FKFS_PDRQ=='2'?'selected':''}>发货日期</option>
												                        <option value="3" ${con.FKFS_PDRQ=='3'?'selected':''}>货到现场日期</option>
												                        <option value="4" ${con.FKFS_PDRQ=='4'?'selected':''}>进场日期</option>
												                        <option value="5" ${con.FKFS_PDRQ=='5'?'selected':''}>验收日期</option>
												                    </select>
												                </td>
																<td>
...
<script type="text/javascript">
	...
	function CNtadAdd(){
		...
		var tr='<tr>'+
	        ...
	        '              <option value='+"'"+'3'+"'"+'>货到现场日期</option>'+
	        '              <option value='+"'"+'4'+"'"+'>进场日期</option>'+
	        '              <option value='+"'"+'5'+"'"+'>验收日期</option>'+
	        '          </select>'+
	        '      </td>'+
			'<td>'+
