	            ...
	            <div class="col-sm-12">
	                <div class="ibox float-e-margins">
	                    ...
	                    <div id="top" name="top"></div>
                            ...
                            <select class="form-control" name="money_type" id="search_money_type" data-placeholder="款项类型" style="vertical-align:top;width:100%" title="款项类型">
	                            ...
	                            <div class="form-group  form-inline ">
	                                <input style="width:170px" type="text" name="search_deviation_days" id="search_deviation_days" placeholder="偏差天数"  class="form-control">
	                            </div>
	                            <div class="form-group form-inline ">
    ...
    <script type="text/javascript">
        ...
        function sel(item_id){
        	$("#EditCollect").kendoWindow({
		        ...
		        title: "信息查看",
		        actions: ["Close"],
		        content: '<%=basePath%>newcollect/getCollect.do?item_id='+item_id,
		        modal : true,
				visible : false,
				resizable : true
		    }).data("kendoWindow").maximize().open();
