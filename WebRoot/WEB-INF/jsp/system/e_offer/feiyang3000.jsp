                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group form-inline">
                                            ...
                                            <label style="width:20%;margin-left:57px"><input type="text" class="form-control m-b" id="FEIYANG_SL" name="FEIYANG_SL" value="${pd.FEIYANG_SL}" readonly="readonly"></label>

                                           <label style="width:9%;margin-top: 25px;margin-bottom: 10px;margin-left: 20px">折扣申请:</label>
                                            <label style="width:20%;"><input type="text" class="form-control m-b" id="FEIYANG_ZK" name="FEIYANG_ZK" value="${pd.FEIYANG_ZK}" onkeyup="countZhj();"></label>%
                                            <!-- <select  class="form-control m-b" id="FEIYANG_ZK" name="FEIYANG_ZK" onchange="countZhj();">
                                                <option value="1">请选择折扣</option>
                                                <option value="0.9" ${pd.FEIYANG_ZK=='0.9'?'selected':''}>90%</option>
                                                <option value="0.6" ${pd.FEIYANG_ZK=='0.6'?'selected':''}>60%</option>
                                                <option value="0.5" ${pd.FEIYANG_ZK=='0.5'?'selected':''}>50%</option>
                                            </select> -->
                                        </div>
                                        <div class="form-group form-inline">
                                            <table class="table table-striped table-bordered table-hover" id="tab" name="tab">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYANG_ZHJ" id="FEIYANG_ZHJ" value="${pd.FEIYANG_ZHJ}"></td>
                                                    <td>
                                                        <input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYANG_SBJ" id="FEIYANG_SBJ" value="${regelevStandardPd.PRICE}">
                                                        <input type="hidden" name="SBJ_TEMP" id="SBJ_TEMP" value="${regelevStandardPd.PRICE}">
                                                    </td>
                                                    <td><font color="red"><span id="zk_">${pd.FEIYANG_ZK}</span></font></td>
                                                    <td><font color="red"><input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYANG_ZHSBJ" id="FEIYANG_ZHSBJ" value="${pd.FEIYANG_ZHSBJ}"></font></td>
                                                    <td>
                                                        <font color="red">
                                                            <input type="text" name="FEIYANG_AZF" id="FEIYANG_AZF" value="${pd.FEIYANG_AZF}"  style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' onkeyup="countZhj();" />
                                                        </font>
                                                    </td>
                                                    <td>
                                                        <font color="red">
                                                            <input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYANG_YSF" id="FEIYANG_YSF" value="${pd.FEIYANG_YSF}">
                                                        </font>
                                                    </td>
                                                    <td><input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYANG_SJBJ" id="FEIYANG_SJBJ" value="${pd.FEIYANG_SJBJ}"></td>
                                                </tr>
                                            </table>
                                        </div>
                                                    ...
                                                    <!-- 基本参数 -->
                                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><input type="text" name="BASE_JDZG_TEMP" id="BASE_JDZG_TEMP"></td>
                                                          </tr><tr>
                                                            <td>导轨支架</td>
                                                            <td colspan="2">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                <select name="OPT_ICK_TEXT" id="OPT_ICK_TEXT" onchange="editOpt('OPT_ICK');" class="form-control" style="width: 100%">
                                                                    ...
                                                                    <option value="刷卡后自动选择到达楼层" ${pd.OPT_ICK=='1'?'selected':''}>刷卡后自动选择到达楼层</option>
                                                                </select>
                                                    ...
                                                    <!-- 操纵盘 -->
                                                        <table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <select name="CZP_XS" id="CZP_XS_1" class="form-control">
                                                                        ...
                                                                        <option value="LED(无偿选配)" ${pd.CZP_XS==''?'selected':'LED(无偿选配)'}>LED(无偿选配)</option>
                                                                        <option value="TFT(彩色液晶)" ${pd.CZP_XS==''?'selected':'TFT(彩色液晶)'}>TFT(彩色液晶)</option>
                                                                    </select>
                                                                    (选配时填写)
                                                            ...
                                                            <td>
                                                                <p>
                                                                    <input name="CZP_CZPXH" ${pd.CZP_CZPXH=='1'?'checked':''} type="radio" value="JFCOP09H-D" onclick="setCzpxhDisable('1');"/>
                                                                    JFCOP09H-D
                                                                </p>
                                                                <p>
                                                                    显示
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group form-inline">
                                            <label>安装价格:</label>
                                            <input type="text" class="form-control" id="FEIYANG_AZF_TEMP" name="FEIYANG_AZF_TEMP" onkeyup="countZhj();" value="${pd.FEIYANG_AZF}">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    function setMPrice(){
        ...
        var price = parseInt($("#FEIYANG_SBJ").val());
    ...
    function editZz(){
        ...
        if(zz_=="450"){ //载重450时
            ...
            //修改开门尺寸
            $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value='800mm×2100mm(450kg)'>800mm×2100mm(450kg)</option>");
            //修改轿厢总高
            ...
            //修改开门尺寸
            $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value='800mm×2100mm(630kg-800kg)'>800mm×2100mm(630kg-800kg)</option>");
            //修改轿厢总高
            ...
            //修改开门宽度
            $("#BZ_KMKD").empty();
            $("#BZ_KMKD").append("<option value='1200'>1200</option>");
            //修改开门尺寸
            $("#BASE_KMCC").empty();
            $("#BASE_KMCC").append("<option value='1200mm×2100mm(2000kg)'>1200mm×2100mm(2000kg)</option>");
            //修改轿厢总高
             $(":radio[name='BASE_JXGD'][value='2500']").prop("checked", "checked");
        }
    ...
    function setJdzg(){
        ...
        if(!isNaN(tsgd_)&&!isNaN(dksd_)&&!isNaN(dcgd_)){
            ...
            if(sd_=="1.0"||sd_=="1.5"||sd_=="1.75"){
                ...
                }else if(zz_=="1350"||zz_=="1600"||zz_=="2000"){
    ...
    function editOpt(option){
        //数量
        var sl_ = $("#FEIYANG_SL").val()==""?0:parseInt($("#FEIYANG_SL").val());
        //价格
        var price = 0;
    ...
    function editDzjksdjxt(){
        var sl_ = parseInt($("#FEIYANG_SL").val());
        var price = 0;
        if(sl_<10){
