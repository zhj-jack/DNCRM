...
<body class="gray-bg">
															...
															<c:forEach items="${e_offers}" var="eo" varStatus="vs2">
																<tr>
																	...
																	<td style="text-align:center;">
																		...
																		<c:if test="${eo.type == '1'}">
																			<button class="btn  btn-warning btn-sm" title="办理" type="button" onclick="goHandlestra('${eo.task_id}','${eo.offer_id}');">办理</button>
																		</c:if>
																	</td>
	...
	<script type="text/javascript">
	 ...
	 //办理任务
	 function goHandlestra(task_id,offer_id){
		 $("#handleLeave").kendoWindow({
			 width: "600px",
			 height: "400px",
			 title: "办理任务",
			 actions: ["Close"],
			 content: '<%=basePath%>e_offer/goHandStra.do?task_id='+task_id+'&offer_id='+offer_id,
			 modal : true,
			 visible : false,
			 resizable : true
