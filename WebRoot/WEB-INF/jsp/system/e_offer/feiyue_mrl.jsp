									...
									<div class="panel-body">
										<div class="form-group form-inline">
											...
											<select style="width: 20%;margin-top: 10px" class="form-control m-b" id="BZ_SD" name="BZ_SD" onchange="editSd();">
												...
												<option value="1.5" ${regelevStandardPd.SD=='1.5'?'selected':''}>1.75</option>
												<option value="1.75" ${regelevStandardPd.SD=='1.75'?'selected':''}>2.0</option>
											</select>
										</div>
										...
										<div class="form-group form-inline">
											...
											<label style="width:20%;margin-left:57px"><input type="text" class="form-control m-b" id="FEIYUEMRL_SL" name="FEIYUEMRL_SL" value="${pd.FEIYUEMRL_SL}" readonly="readonly"></label>

											<label style="width:9%;margin-top: 25px;margin-bottom: 10px;margin-left: 20px">折扣申请:</label>
											<label style="width:20%;"><input type="text" class="form-control m-b" id="FEIYUEMRL_ZK" name="FEIYUEMRL_ZK" value="${pd.FEIYUEMRL_ZK}" onkeyup="countZhj();"></label>%
											<!-- <select  class="form-control m-b" id="FEIYUEMRL_ZK" name="FEIYUEMRL_ZK" onchange="countZhj();">
												<option value="1">请选择折扣</option>
												<option value="0.9" ${pd.FEIYUEMRL_ZK=='0.9'?'selected':''}>90%</option>
                                                <option value="0.6" ${pd.FEIYUEMRL_ZK=='0.6'?'selected':''}>60%</option>
                                                <option value="0.5" ${pd.FEIYUEMRL_ZK=='0.5'?'selected':''}>50%</option>
											</select> -->
										</div>
										<div class="form-group form-inline">
											<table class="table table-striped table-bordered table-hover" id="tab" name="tab">
												...
												<tr>
													...
													<td><input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYUEMRL_ZHJ" id="FEIYUEMRL_ZHJ" value="${pd.FEIYUEMRL_ZHJ}"></td>
													<td><input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYUEMRL_SBJ" id="FEIYUEMRL_SBJ" value="${regelevStandardPd.PRICE}">
													<input type="hidden" name="SBJ_TEMP" id="SBJ_TEMP" value="${regelevStandardPd.PRICE}">
													</td>
													<td><font color="red"><span id="zk_">${pd.FEIYUEMRL_ZK}</span></font></td>
													<td><font color="red"><input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYUEMRL_ZHSBJ" id="FEIYUEMRL_ZHSBJ" value="${pd.FEIYUEMRL_ZHSBJ}"></font></td>
													<td>
                                                        <font color="red">
                                                            <input type="text" name="FEIYUEMRL_AZF" id="FEIYUEMRL_AZF" value="${pd.FEIYUEMRL_AZF}"  style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' onkeyup="countZhj();" />
                                                        </font>
                                                    </td>
                                                    <td>
                                                        <font color="red">
                                                            <input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYUEMRL_YSF" id="FEIYUEMRL_YSF" value="${pd.FEIYUEMRL_YSF}">
                                                        </font>
                                                    </td>
													<td><input type="text" style='width:50px;border-left:0px;border-top:0px;border-right:0px;border-bottom:1px ' name="FEIYUEMRL_SJBJ" id="FEIYUEMRL_SJBJ" value="${pd.FEIYUEMRL_SJBJ}"></td>
												</tr>
											</table>
										</div>
													...
													<!-- 基本参数 -->
														<table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
														  ...
														  <tr>
															<td>井道尺寸HW*HD</td>
															<td colspan="2">
																<input name="BASE_JDK" id="BASE_JDK" type="text" class="form-control" style="width: 15%" value="${pd.BASE_JDK}"/>
																mm宽×
																<input name="BASE_JDS" id="BASE_JDS" type="text" class="form-control" style="width: 15%" value="${pd.BASE_JDS}"/>
																mm深
															</td>
															<td></td>
														  </tr>
														  ...
														  <tr>
															...
															<td>
																<input type="text" name="BASE_JDZG_TEMP" id="BASE_JDZG_TEMP" class="form-control">
															</td>
														  </tr><tr>
															<td>导轨支架</td>
															<td colspan="2">
															...
															<td>
																<input type="text" name="BASE_DGZJ_TEMP" id="BASE_DGZJ_TEMP" class="form-control">
															</td>
														  </tr>
														</table>
													<!-- 基本参数 -->
														  ...
														  <tr>
															...
															<td><input name="JXZH_FSXH" type="radio" value="" onclick="setFsxhDisable('0');" ${pd.JXZH_FSXH=='无'?'':'checked'}/>
															  <select name="JXZH_FSXH_SELECT" id="JXZH_FSXH_SELECT" onchange="editJxzh('JXZH_FSXH');" class="form-control">
																...
																<option value="JF-FS-05" ${pd.JXZH_FSXH=='JF-FS-05'?'selected':''}>JF-FS-05</option>
															  </select>
															</td>
														  ...
														  <tr>
															...
															<td colspan="2">
																<select id="TMMT_SCMKCZ" name="TMMT_SCMKCZ" onchange="editTmmt('TMMT_SCMKCZ');" class="form-control">
																	...
																	<option value="钢板喷涂" ${pd.TMMT_SCMKCZ=='发纹不锈钢'?'selected':''}>钢板喷涂</option>
																	<option value="镜面不锈钢" ${pd.TMMT_SCMKCZ=='发纹不锈钢'?'selected':''}>镜面不锈钢</option>
																</select>
															<td>
														...
														<table class="table table-striped table-bordered table-hover" border="1" cellspacing="0">
														  ...
														  <tr>
															<td>
																<p>
																	在
																	<input name="TMXHZZ_ZDJC" type="text"  id="TMXHZZ_ZDJC_1" class="form-control" style="width: 15%" value="${pd.TMXHZZ_ZDJC}"/>
																	层、每层
																	<input name="TMXHZZ_MCGS" type="text" id="TMXHZZ_MCGS_1" class="form-control" style="width: 15%" value="${pd.TMXHZZ_MCGS}"/>
																	个
																</p>
																<p>
																	附加说明:
															...
															<td>
																<p>
																	在
																	<input name="TMXHZZ_ZDJC" type="text" id="TMXHZZ_ZDJC_2" class="form-control" style="width: 15%" value="${pd.TMXHZZ_ZDJC}"/>
																	层、每层
																	<input name="TMXHZZ_MCGS" type="text" id="TMXHZZ_MCGS_2" class="form-control" style="width: 15%" value="${pd.TMXHZZ_MCGS}"/>
																	个
																</p>
																<p>
																	附加说明:
							...
							<div class="col-sm-12">
								<div class="panel panel-primary">
									...
									<div class="panel-body">
										<div class="form-group form-inline">
											<label>安装价格:</label>
											<input type="text" class="form-control" id="FEIYUEMRL_AZF_TEMP" name="FEIYUEMRL_AZF_TEMP" onkeyup="countZhj();" value="${pd.FEIYUEMRL_AZF}">
										</div>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function countZhj(){
        ...
        $("#FEIYUEMRL_SBJ").val(sbj_temp+sbj_count);
		//运输费
        var feiyuemrl_ysf = $("#FEIYUEMRL_YSF").val()==""?0:parseInt($("#FEIYUEMRL_YSF").val());
        $("#FEIYUEMRL_YSF").val(feiyuemrl_ysf);
        //安装费
        var feiyuemrl_azf = $("#FEIYUEMRL_AZF_TEMP").val()==""?0:parseInt($("#FEIYUEMRL_AZF_TEMP").val());
        $("#FEIYUEMRL_AZF").val(feiyuemrl_azf);

		var feiyuemrl_zk = parseFloat($("#FEIYUEMRL_ZK").val())/100;
		if(!isNaN(feiyuemrl_zk)){
			var feiyuemrl_sbj = parseInt($("#SBJ_TEMP").val());
	...
	function editOpt(option){
		//数量
		var sl_ = $("#FEIYUEMRL_SL").val()==""?0:parseInt($("#FEIYUEMRL_SL").val());
		//价格
		var price = 0;
		if(option=="OPT_LTBL"){
			//两台并联
	...
	function editDzjksdjxt(){
		var sl_ = parseInt($("#FEIYUEMRL_SL").val());
		var price = 0;
		if(sl_<10){
