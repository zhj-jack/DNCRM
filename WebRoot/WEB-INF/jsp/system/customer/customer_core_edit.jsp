	                                ...
	                                <div class="panel-body">		
				                        <div class="form-group form-inline">
				                            ...
				                            <select style="width:22%" name="customer_level" id="customer_level" class="form-control m-b">
				                            	...
				                            	<option value="A" ${pd.customer_level=="A"?"selected":""}>A级</option>
				                            	<option value="B" ${pd.customer_level=="B"?"selected":""}>B级</option>
				                            	<option value="C" ${pd.customer_level=="C"?"selected":""}>C级</option>
				                            </select>
