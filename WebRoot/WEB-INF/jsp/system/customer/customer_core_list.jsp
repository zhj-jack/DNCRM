	                    ...
	                    <div id="top",name="top"></div>
	                        ...
	                        <div class="table-responsive">
								...
								<div class="col-lg-12" style="padding-left:0px;padding-right:0px">
									...
									<a class="btn btn-warning btn-outline" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>customer/toExcelCore.do">导出</a>
									...
									<button type="button" class="btn  btn-success" title="下载数据模板" onclick="downFile()">下载模板</button>
									${page.pageStr}
								</div>
								</div>
	                        </div>
