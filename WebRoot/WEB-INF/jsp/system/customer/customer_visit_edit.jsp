            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="form-group form-inline">
                        ...
                        <input type="text" name="visit_way" id="visit_way"  value="${pd.visit_way}"   title="拜访方式"   class="form-control">
                        <label style="margin-left:50px;margin-top:20px">参与成员:</label>
				          <select style="width:100%" class="selectpicker" multiple data-live-search="true" data-live-search-placeholder="查找" data-actions-box="true" name="visit_member_text" id="visit_member_text">
				            <optgroup label="人员列表">
				            	<c:forEach items="${sysUserList}" var="var" >
										<option value="${var.USER_ID }"  
											<c:forEach items="${members}" var="member">
											${var.USER_ID==member?'selected':''}
											</c:forEach>
										>${var.NAME }</option>
								</c:forEach>
				            </optgroup>
				          </select>
				          <input type="hidden" id="visit_member" name="visit_member"/>
                    </div>
