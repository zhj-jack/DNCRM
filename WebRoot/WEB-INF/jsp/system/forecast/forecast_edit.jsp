                        			...
                        			<div class="panel-body">
				                        <div class="form-group form-inline">
                        					<table class="table table-striped table-bordered table-hover">
				                                <thead>
				                                    <tr>
				                                        <th style="width:5%;">预测编号</th>
				                                        <th style="width:10%;">上月台量</th>
				                                        <th style="width:10%;">上月指标</th>
				                                        <th style="width:10%;">指标(百分比)</th>
				                                    </tr>
				                                </thead>
			                                	<tbody>
			                                		<c:choose>
                    			...
                    			<div class="panel panel-primary">
                        			...
                        			<div class="panel-body">
				                        <div class="form-group form-inline">
				                        	...
				                        	<input style="width:22%" type="text" name="now_count" id="now_count"  value="${pd.now_count}"  title="本月当前台量"  placeholder="这里输入本月当前台量" class="form-control">
                        					...
                        					<label style="width:10%;margin-top: 25px;margin-bottom: 10px">本月指标:</label>
				                        	<input style="width:22%" readonly="readonly"  type="text" name="month_quota" id="month_quota"  value="${pd.month_quota}"  title="本月指标"  placeholder="这里输入本月指标" class="form-control">
                        					<label style="width:10%;margin-top: 25px;margin-bottom: 10px">指标(百分比):</label>
				                        	<input style="width:22%" readonly="readonly" type="text" name="percent" id="percent"  value="${pd.percent}"  title="指标百分比"  placeholder="这里输入指标百分比" class="form-control">
				                        	<label>%</label>
				                        </div>
				                        <!-- <div class="form-group form-inline">
                    			...
                    			<div class="panel panel-primary">
                        			...
                        			<div class="panel-body">
				                        <div class="form-group form-inline">
				                        	...
				                        	<label style="width:10%;margin-top: 25px;margin-bottom: 10px">下月指标:</label>
				                        	<input style="width:22%" readonly="readonly"  type="text" name="quota_next" id="quota_next"  value="${pd.quota_next}"  title="本月指标"  placeholder="这里输入本月指标" class="form-control">
                        					<label style="width:10%;margin-top: 25px;margin-bottom: 10px">指标(百分比):</label>
				                        	<input style="width:22%" readonly="readonly" type="text" name="percent_next" id="percent_next"  value="${pd.percent_next}"  title="指标百分比"  placeholder="这里输入指标百分比" class="form-control">
				                        	<label>%</label>
				                        </div>
	                                </div>
	                            </div>
