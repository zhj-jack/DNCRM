								...
								<div class="form-group form-inline">
									...
									<span type="hidden">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span> <label
										style="width: 9%">楼盘所属区域:</label> 
										 <input type="text" readonly="readonly" style="width:21%" disabled="disabled" name="customer_area_text_ordinary" id="customer_area_text_ordinary" value="${pd.customer_area_text }"  placeholder="请选择区域" title="所属区域" class="form-control" onclick="showAreaMenuOrdinary();"/>
                                           <input style="width:170px"  type="hidden"  name="customer_area_ordinary" id="customer_area_ordinary"  value="${pd.customer_area}"   title="所属区域"   class="form-control" >
								</div>
								<div class="form-group form-inline">
									<label style="width: 9%">楼盘地址:</label>
										 <select style="width:21.5%" class="form-control" disabled="disabled" name="province_id" id="province_id" title="区域">
		                                        	<option value="">请选择</option>
										    		<c:forEach var="province" items="${provinceList}" >
										    		<option value="${province.id }" <c:if test="${pd.province_id eq province.id }">selected</c:if>  >${province.name }</option>
										    		</c:forEach>
												</select>
											<select style="width: 21.5%" id="city_id" disabled="disabled" name="city_id" class="form-control" disabled="disabled" title="城市">
												<option value="">请选择</option>
										    	<c:forEach var="city" items="${cityList}" >
										    		<option value="${city.id }" <c:if test="${pd.city_id eq city.id }">selected</c:if>  >${city.name }</option>
										    	</c:forEach>
											</select>
	                                        <select style="width:21.5%" class="form-control" disabled="disabled" name="county_id" id="county_id" title="郡/县" disabled="disabled">
	                                        	<option value="">请选择</option>
                                        	...
                                        	<input style="width:22%" class="form-control" disabled="disabled" type="text" name="agent_address" id="agent_address" placeholder="这里输入地址" value="${pd.address_name}"  />		
								</div>
								   <div class="form-group form-inline">
								<label
										style="width: 9%">楼盘类型:</label> <select style="width: 21%" disabled="disabled"
										class="form-control" name="type_name" id="type_name">
										<option value="">请选择</option>
									...
									<label style="width: 9%">楼盘状态:</label> <select disabled="disabled"
									 ...
									 <span type="hidden">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
								   	<label style="width: 9%">别墅数量:</label> <input disabled="disabled"
										...
										value="${pd.villadom_num}" placeholder="这里输入别墅数量"
								 ...
								 <div class="form-group form-inline">
								   <label style="width: 9%">楼盘相关项目:</label> <input disabled="disabled"
									...
									<select style="width: 21%" class="form-control" disabled="disabled" name="houses_style" id="houses_style">
									...
									<select style="width: 21%" class="form-control" name="is_templet" id="is_templet" disabled="disabled">
									  <option value="">请选择</option>
								   ...
								   <div class="form-group form-inline">
										  ...
										  <input style="width: 21%" disabled="disabled" type="text" value="${pd.modified_by}" class="form-control">
										  <label style="width: 9%;margin-left:30px;">录入时间:</label> 
										  <input style="width: 21%" disabled="disabled" type="text" value="${pd.entering_time}" class="form-control">
										  <label style="width: 9%;margin-left:30px;">最后修改人:</label> 
										  <input style="width: 21%" disabled="disabled" type="text" value="${pd.modified_name}" class="form-control">
								   </div>
								<div id="housesT">
								<div class="form-group form-inline">
								  <label style="width: 9%;">楼盘效果图附件:</label> 
								   <input class="form-control" type="hidden" name="house_type_img"
									...
									<button style="margin-left:3px;margin-top:3px;" class="btn  btn-primary btn-sm" disabled="disabled"
								...
								<div id="delivery">
								    <div class="form-group form-inline">
								      <span style="color: red;">*</span>
									   ...
									   disabled="disabled" value="${pd.delivery_time}" onclick="laydate()" class="form-control">
								       ...
								       <button style="margin-left:3px;margin-top:3px;" class="btn  btn-primary btn-sm" title="添加" 
								            disabled="disabled" type="button"onclick="addDelivery();">加</button>
								    </div>
								</div>
							  </div>
							</div>	
							...
							<div class="panel-body">
								<div class="form-group form-inline">
									<label style="width: 9%">物业公司名称:</label> <input disabled="disabled"
										...
										placeholder="这里输入楼盘联系电话" title="楼盘联系电话" class="form-control">
									<label style="width: 9%;margin-left: 30px;">物业联系人:</label> <input disabled="disabled"
										...
										placeholder="这里输入楼盘联系人" title="楼盘联系人" class="form-control">
									<label style="width: 9%;margin-left: 30px;">物业联系人电话:</label> <input disabled="disabled"
										...
										placeholder="这里输入楼盘联系人电话" title="楼盘联系人电话" class="form-control">
								
								</div>
								<div class="form-group form-inline">
									<label style="width: 9%">物业传真:</label> <input style="width: 21%" disabled="disabled"
										type="text" type="text" name="houses_faxes" id="houses_faxes"
										value="${pd.houses_faxes}" placeholder="这里输入楼盘传真" title="传真"
										class="form-control"> 
									<label style="width: 9%;margin-left: 30px;">物业邮箱:</label> <input style="width: 21%" disabled="disabled"
										type="text" name="houses_email" id="houses_email"
										value="${pd.houses_email}" placeholder="这里输入楼盘邮箱" title="邮箱"
										class="form-control"> 
									<label style="width: 9%;margin-left: 30px;">物业邮编:</label> <input style="width: 21%" disabled="disabled"
										type="text" type="text" name="houses_postcode"
										id="houses_postcode" value="${pd.houses_postcode}"
										placeholder="这里输入楼盘所在地邮编" title="邮编" class="form-control">
								</div>
								...
								<div class="form-group form-inline">
									...
									<label style="width: 9%;margin-left: 30px;">备注:</label> <input style="width: 21%" disabled="disabled"
										type="text" name="remarks" id="remarks" value="${pd.remarks}"
							...
							<div class="panel-body">
								<div class="form-group form-inline" style="margin-top: 10px">
									<label style="width: 9%">开发商公司名称:</label> <input disabled="disabled"
										...
										value="${pd.customer_name}" placeholder="这里输入开发商公司名称"
								...
								<div class="form-group form-inline">
									...
									<label style="width: 9%;margin-left: 30px;">开发商公司传真:</label> <input disabled="disabled"
										...
										title="开发商公司传真" class="form-control">
