						...
						<div class="panel panel-primary">
								...
								<div class="form-group form-inline">
									...
									<label
										style="width: 9%">楼盘所属区域:</label> 
										 <input type="text" readonly="readonly" style="width:21%" name="customer_area_text_ordinary" id="customer_area_text_ordinary" value="${pd.customer_area_text }"  placeholder="请选择区域" title="所属区域" class="form-control" onclick="showAreaMenuOrdinary();"/>
								...
								<div class="form-group form-inline">
								 <span style="color: red;">*</span>
									<label style="width: 9%">楼盘地址:</label>
										 <select style="width:21.5%" class="form-control" name="province_id" id="province_id" title="区域">
		                                        	<option value="">请选择</option>
										    		<c:forEach var="province" items="${provinceList}" >
										    		<option value="${province.id }" <c:if test="${pd.province_id eq province.id }">selected</c:if>  >${province.name }</option>
										    		</c:forEach>
												</select>
											<select style="width: 21.5%" id="city_id" name="city_id" class="form-control" disabled="disabled" title="城市">
												<option value="">请选择</option>
										    	<c:forEach var="city" items="${cityList}" >
										    		<option value="${city.id }" <c:if test="${pd.city_id eq city.id }">selected</c:if>  >${city.name }</option>
										    	</c:forEach>
											</select>
	                                        <select style="width:21.5%" class="form-control" name="county_id" id="county_id" title="郡/县" disabled="disabled">
	                                        	<option value="">请选择</option>
                                        	...
                                        	<input style="width:22%" class="form-control" type="text" name="agent_address" id="agent_address" placeholder="这里输入地址" value="${pd.address_name}"  />
								</div>						   
								   <div class="form-group form-inline">
								    <span type="hidden">&nbsp&nbsp</span>
								<label
									...
									<span style="color: red;margin-left:18px;">*</span>
								   	...
								   	<input style="width: 21%" type="text" type="text" name="villadom_num" id="villadom_num"
										value="${pd.villadom_num}" placeholder="这里输入别墅数量" title="别墅数量" class="form-control">
								   </div>
							    <c:if test="${msg== 'editS' }">
									<div class="form-group form-inline">
										  <label style="width:9%;margin-left:10px;">录入人:</label> 
										  <input style="width: 21%" type="text" readonly="readonly" value="${pd.modified_by}" class="form-control">
										   <label style="width: 9%;margin-left:40px;">录入时间:</label> 
										  <input style="width: 21%" type="text" readonly="readonly" value="${pd.entering_time}" class="form-control">
										  <label style="width: 9%;margin-left:29px;">最后修改人:</label> 
										  <input style="width: 21%" type="text" readonly="readonly" value="${pd.modified_name}" class="form-control">									 
								   </div>
								 </c:if>
								  <div class="form-group form-inline">
								   ...
								   <label style="width: 9%;margin-left:28px;">户型数:</label> 
										  ...
										  value="${pd.households}" placeholder="这里输入楼盘户型数" title="楼盘户型数" class="form-control">
								</div>
								 <div class="form-group form-inline">
						 ...
						 <div class="panel panel-primary">
							<div class="panel-heading">楼盘交付信息</div>
							  <div class="panel-body">
							     <div class="form-group form-inline">
									 ...
									 <input style="width: 21%" type="text" id="delivery_id" name="delivery_id" readonly="readonly"
								...
								<div id="delivery">
								    <div class="form-group form-inline">
								      <span style="color: red;">*</span>
								       ...
								       <button style="margin-left:3px;margin-top:3px;" class="btn  btn-primary btn-sm" title="添加" type="button"onclick="addDelivery();">加</button>
								    </div>
								</div>
							  </div>
							</div>	
							...
							<div class="panel-body">	   
								...
								<div class="form-group form-inline">
								<span style="color: red;">*</span>
									<label style="width: 9%">物业公司名称:</label> <input
								...
								<span type="hidden">&nbsp&nbsp</span>
									<label style="width: 9%">物业传真:</label> <input style="width: 21%"
										...
										value="${pd.houses_faxes}" placeholder="这里输入物业传真" title="传真"
									...
									<label style="width: 9%">物业邮箱:</label> <input style="width: 21%"
										...
										value="${pd.houses_email}" placeholder="这里输入物业邮箱" title="邮箱"
										class="form-control"> <span type="hidden">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</span>
									<label style="width: 9%">物业邮编:</label> <input style="width: 21%"
										...
										placeholder="这里输入物业所在地邮编" title="邮编" class="form-control">
								</div>
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								<span style="color: red;">*</span> 
									...
									<select class="selectpicker" data-live-search="true" data-width="16.5%" name="houses_dev_name" id="houses_dev_name">
										<option value="">请选择</option>
									...
									<button style="margin-left:3px;margin-top:3px;" class="btn  btn-primary btn-sm" title="刷新" type="button"onclick="comp();">刷新</button>
