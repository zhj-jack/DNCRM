							  ...
							  <div class="panel panel-primary">
                                ...
                                <div class="panel-body" >
                                    ...
                                    <div class="form-group form-inline">
                                        ...
                                        <textarea class="form-control" rows="10" cols="20" name="models_description" id="models_description" placeholder="这里输入型号描述" maxlength="250" title="型号描述" >${pd.models_description}</textarea>
                                    </div>
                               </div>
                            </div>
                        </div>
