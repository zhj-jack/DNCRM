	                    ...
	                    <div id="top" name="top"></div>
	                        ...
	                        <div class="table-responsive">
													...
													<tr>
														...
														<td>
															...
															<div>
																...
																<c:if test="${QX.edit == 1 && var.item_status == 1}">
																...
																<c:if test="${QX.cha == 1 && var.item_status == 1}">
																	<button class="btn btn-sm btn-warning btn-sm" title="提交" type="button" onclick="sub('${var.item_id}');">提交</button>
																</c:if>
															</div>
														</td>
													</tr>
								...
								<div class="col-lg-12" style="padding-left:0px;padding-right:0px">
									...
									<a class="btn btn-warning btn-outline" title="导出到Excel" type="button" target="_blank" href="<%=basePath%>item/toExcel.do">导出</a>
