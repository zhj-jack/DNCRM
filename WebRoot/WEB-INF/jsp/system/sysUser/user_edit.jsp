...
//            }
        ...
        function onClick(e, treeId, treeNode) {
            ...
            positionObj.attr("value", treeNode.name);
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                        <label>用户名:</label>
                                        <input type="text" name="USERNAME" id="loginname" value="${pd.USERNAME }" <c:if test="${msg == 'saveU'}">onblur="hasU()"</c:if>  placeholder="这里输入用户名" class="form-control">
                                    </div>
                                <div class="form-group">
                                    <label>编号</label>
                                    <input type="text" name="NUMBER" id="NUMBER" value="${pd.NUMBER }" maxlength="32" onblur="hasN('${pd.USERNAME }')" placeholder="这里输入编号" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty pd.POSITION_ID}">
                                            <input type="text" value="${pd.POSITION}" readonly name="POSITION" id="POSITION" class="form-control" placeholder="请点击选择岗位" onclick="showMenu();">
                                        </c:when>
                                        <c:otherwise>
                                            <input type="text" value="" readonly name = "POSITION" id="POSITION" class="form-control" placeholder="请点击选择岗位" onclick="showMenu();">
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                <%--岗位选择start--%>
                                ...
                                <div class="form-group">
                                    <label>姓名</label>
                                    <input type="text" name="NAME" id="name" value="${pd.NAME }" maxlength="32" placeholder="这里输入姓名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>手机号</label>
                                    <input type="number" name="PHONE" id="PHONE" value="${pd.PHONE }" maxlength="32" placeholder="这里输入手机号" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>邮箱</label>
                                    <input type="email" name="EMAIL" id="EMAIL" value="${pd.EMAIL }" maxlength="32" placeholder="这里输入邮箱" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>备注</label>
                                    <input type="text" name="BZ" id="BZ" value="${pd.BZ }" placeholder="这里输入备注" maxlength="64" class="form-control">
                                </div>
                                <div class="form-group">
                                <c:choose>
                                <c:when test="${pd.ROLE_ID=='06e6e74a24674ae2ac65e66667261911' && fx=='head'}">
