    ...
    public ModelAndView toExcel(){
    	...
    	try{
			...
			for(int i = 0; i < ordinaryList.size(); i++){
				...
				vpd.put("var2", ordinaryList.get(i).getString("customer_no"));
				vpd.put("var3", ordinaryList.get(i).getString("customer_name"));
				/*vpd.put("var4", ordinaryList.get(i).getString("customer_type"));*/
				vpd.put("var4", "普通客户");
				vpd.put("var5", ordinaryList.get(i).getString("customer_ordinary_type"));
				vpd.put("var6", ordinaryList.get(i).getString("customer_trade_excel"));
				vpd.put("var7", ordinaryList.get(i).getString("customer_status"));
				vpd.put("var8", ordinaryList.get(i).getString("customer_area_excel"));
				vpd.put("var9", ordinaryList.get(i).getString("customer_company_excel"));
				vpd.put("var10", ordinaryList.get(i).getString("company_address"));
				vpd.put("var11", ordinaryList.get(i).getString("company_property"));
				vpd.put("var12", ordinaryList.get(i).getString("company_phone"));
				vpd.put("var13", ordinaryList.get(i).getString("company_email"));
				vpd.put("var14", ordinaryList.get(i).getString("company_fax"));
				vpd.put("var15", ordinaryList.get(i).getString("company_postcode"));
				vpd.put("var16", ordinaryList.get(i).getString("company_tax"));
				vpd.put("var17", ordinaryList.get(i).getString("company_bank"));
				vpd.put("var18", ordinaryList.get(i).getString("bank_no"));
				vpd.put("var19", ordinaryList.get(i).getString("customer_contact"));
				vpd.put("var20", ordinaryList.get(i).getString("contact_duty"));
				vpd.put("var21", ordinaryList.get(i).getString("contact_phone"));
				vpd.put("var22", ordinaryList.get(i).getString("contact_email"));
				vpd.put("var23", ordinaryList.get(i).getString("business_license"));
				vpd.put("var24", ordinaryList.get(i).getString("legal_represent"));
				vpd.put("var25", ordinaryList.get(i).getString("employee_num"));
				vpd.put("var26", ordinaryList.get(i).getString("found_source"));
				vpd.put("var27", ordinaryList.get(i).getString("business_and_scope"));
				vpd.put("var28", ordinaryList.get(i).getString("business_status"));
				vpd.put("var29", ordinaryList.get(i).getString("decision_make1"));
				vpd.put("var30", ordinaryList.get(i).getString("dm_name1"));
				vpd.put("var31", ordinaryList.get(i).getString("dm_duty1"));
				vpd.put("var32", ordinaryList.get(i).getString("dm_phone1"));
				vpd.put("var33", ordinaryList.get(i).getString("dm_sex1"));
				vpd.put("var34", ordinaryList.get(i).getString("dm_age1"));
				vpd.put("var35", ordinaryList.get(i).getString("dm_edubg1"));
				vpd.put("var36", ordinaryList.get(i).getString("dm_hobby1"));
				vpd.put("var37", ordinaryList.get(i).getString("dm_birthday1"));
				vpd.put("var38", ordinaryList.get(i).getString("decision_make2"));
				vpd.put("var39", ordinaryList.get(i).getString("dm_name2"));
				vpd.put("var40", ordinaryList.get(i).getString("dm_duty2"));
				vpd.put("var41", ordinaryList.get(i).getString("dm_phone2"));
				vpd.put("var42", ordinaryList.get(i).getString("dm_sex2"));
				vpd.put("var43", ordinaryList.get(i).getString("dm_age2"));
				vpd.put("var44", ordinaryList.get(i).getString("dm_edubg2"));
				vpd.put("var45", ordinaryList.get(i).getString("dm_hobby2"));
				vpd.put("var46", ordinaryList.get(i).getString("dm_birthday2"));
				vpd.put("var47", ordinaryList.get(i).getString("decision_make3"));
				vpd.put("var48", ordinaryList.get(i).getString("dm_name3"));
				vpd.put("var49", ordinaryList.get(i).getString("dm_duty3"));
				vpd.put("var50", ordinaryList.get(i).getString("dm_phone3"));
				vpd.put("var51", ordinaryList.get(i).getString("dm_sex3"));
				vpd.put("var52", ordinaryList.get(i).getString("dm_age3"));
				vpd.put("var53", ordinaryList.get(i).getString("dm_edubg3"));
				vpd.put("var54", ordinaryList.get(i).getString("dm_hobby3"));
				vpd.put("var55", ordinaryList.get(i).getString("dm_birthday3"));
				vpd.put("var56", ordinaryList.get(i).getString("relation_descript"));
				vpd.put("var57", ordinaryList.get(i).getString("customer_ratings"));
				vpd.put("var58", ordinaryList.get(i).getString("credit_ratings"));
				vpd.put("var59", ordinaryList.get(i).getString("respond_salesman_excel"));
				vpd.put("var60", ordinaryList.get(i).getString("start_flag").equals("0")?"未启用":"已启用");
				vpd.put("var61", ordinaryList.get(i).getString("remark"));
				vpd.put("var62", ordinaryList.get(i).getString("modified_by_excel"));
				vpd.put("var63", ordinaryList.get(i).getString("modified_date"));
				vpd.put("var64", ordinaryList.get(i).getString("input_date"));
				vpd.put("var65", ordinaryList.get(i).getString("input_user_excel"));
				...
				vpd.put("var67", ordinaryList.get(i).getString("customer_branch_excel"));
				varList.add(vpd);
			}
    ...
    public ModelAndView toExcelMerchant(){
    	...
    	try{
    		...
    		for(int i=0; i< merchantList.size(); i++){
    			...
    			vpd.put("var2", merchantList.get(i).getString("customer_no"));
    			vpd.put("var3", "小业主");
    			vpd.put("var4", merchantList.get(i).getString("customer_name"));
    			vpd.put("var5", merchantList.get(i).getString("customer_hobby"));
    			vpd.put("var6", merchantList.get(i).getString("customer_birthday"));
    			vpd.put("var7", merchantList.get(i).getString("customer_company_excel"));
    			vpd.put("var8", merchantList.get(i).getString("customer_ratings"));
    			vpd.put("var9", merchantList.get(i).getString("customer_project"));
    			vpd.put("var10", merchantList.get(i).getString("customer_contact"));
    			vpd.put("var11", merchantList.get(i).getString("contact_phone"));
    			vpd.put("var12", merchantList.get(i).getString("contact_way"));
    			vpd.put("var13", merchantList.get(i).getString("contact_address"));
    			vpd.put("var14", merchantList.get(i).getString("contact_emergency_one"));
    			vpd.put("var15", merchantList.get(i).getString("em_one_phone"));
    			vpd.put("var16", merchantList.get(i).getString("contact_emergency_two"));
    			vpd.put("var17", merchantList.get(i).getString("em_two_phone"));
    			vpd.put("var18", merchantList.get(i).getString("respond_salesman_excel"));
    			vpd.put("var19", merchantList.get(i).getString("service_man_excel"));
    			vpd.put("var20", merchantList.get(i).getString("project_source"));
    			vpd.put("var21", merchantList.get(i).getString("type_specifiaction"));
    			vpd.put("var22", merchantList.get(i).getString("config"));
    			vpd.put("var23", merchantList.get(i).getString("design_sketch"));
    			vpd.put("var24", merchantList.get(i).getString("price"));
    			vpd.put("var25", merchantList.get(i).getString("agent_company"));
    			vpd.put("var26", merchantList.get(i).getString("agent_name"));
    			vpd.put("var27", merchantList.get(i).getString("agent_brand"));
    			vpd.put("var28", merchantList.get(i).getString("agent_ratings"));
    			vpd.put("var29", merchantList.get(i).getString("agent_property"));
    			vpd.put("var30", merchantList.get(i).getString("remark"));
    			vpd.put("var31", merchantList.get(i).getString("modified_by_excel"));
    			vpd.put("var32", merchantList.get(i).getString("modified_date"));
    			vpd.put("var33", merchantList.get(i).getString("customer_status"));
    			vpd.put("var34", merchantList.get(i).getString("input_date"));
    			vpd.put("var35", merchantList.get(i).getString("input_user_excel"));
    			vpd.put("var36", merchantList.get(i).getString("is_core").equals("0")?"否":"是");
    			vpd.put("var37", merchantList.get(i).getString("customer_org"));
    			vpd.put("var38", merchantList.get(i).getString("customer_email"));
    			vpd.put("var39", merchantList.get(i).getString("houses_no_excel"));
    			varList.add(vpd);
    		}
    		dataMap.put("varList", varList);
    		ObjectExcelView erv = new ObjectExcelView();
    ...
    public ModelAndView toExcelCore(){
    	...
    	try{
    		...
    		for(int i=0; i< coreList.size(); i++){
    			...
    			vpd.put("var2", coreList.get(i).getString("customer_no"));
    			vpd.put("var3", coreList.get(i).getString("customer_type"));
    			vpd.put("var4", coreList.get(i).getString("collector_excel"));
    			vpd.put("var5", coreList.get(i).getString("collector_phone"));
    			vpd.put("var6", coreList.get(i).get("collector_time").toString());
    			vpd.put("var7", coreList.get(i).getString("keyperson_name1"));
    			vpd.put("var8", coreList.get(i).getString("keyperson_duty1"));
    			vpd.put("var9", coreList.get(i).getString("keyperson_phone1"));
    			vpd.put("var10", coreList.get(i).getString("keyperson_name2"));
    			vpd.put("var11", coreList.get(i).getString("keyperson_duty2"));
    			vpd.put("var12", coreList.get(i).getString("keyperson_phone2"));
    			vpd.put("var13", coreList.get(i).getString("has_cooperate_pro").equals("0")?"否":"是");
    			vpd.put("var14", coreList.get(i).getString("now_cooperate_pro").equals("0")?"否":"是");
    			vpd.put("var15", coreList.get(i).getString("cooperate_pro_id_excel"));
    			vpd.put("var16", coreList.get(i).getString("pro_status"));
    			vpd.put("var17", coreList.get(i).getString("is_core_cooperate").equals("0")?"否":"是");
    			vpd.put("var18", coreList.get(i).getString("core_cooperate_agre"));
    			vpd.put("var19", coreList.get(i).getString("core_cooperate_date"));
    			vpd.put("var20", coreList.get(i).getString("core_cooperate_num"));
    			vpd.put("var21", coreList.get(i).getString("core_coopaerate_money"));
    			vpd.put("var22", coreList.get(i).getString("customer_name"));
    			vpd.put("var23", coreList.get(i).getString("customer_company_excel"));
    			vpd.put("var24", coreList.get(i).getString("input_date"));
    			vpd.put("var25", coreList.get(i).getString("input_user_excel"));
    			vpd.put("var26", coreList.get(i).getString("modified_by_excel"));
    			vpd.put("var27", coreList.get(i).getString("modified_date"));
    			vpd.put("var28", coreList.get(i).getString("customer_level")+"级");
    			varList.add(vpd);
    		}
    		dataMap.put("varList", varList);
    		ObjectExcelView erv = new ObjectExcelView();
