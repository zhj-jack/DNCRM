...
public class SysAgentController extends BaseController{
    ...
    public ModelAndView listPendingAgent(Page page){
          ...
          try{
              ...
              List<Task> toHandleList = workFlow.getTaskService().createTaskQuery().taskCandidateOrAssigned(USER_ID).processDefinitionKey("agent").orderByTaskCreateTime().desc().active().listPage(firstResult, maxResults);
